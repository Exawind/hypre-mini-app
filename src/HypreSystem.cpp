...
namespace nalu {
  ...
  void HypreSystem::setup_preconditioner()
  {
    ...
    HYPRE_BoomerAMGSetCycleType (precond_, 1);
    HYPRE_BoomerAMGSetRelaxType(precond_, 3);
    HYPRE_BoomerAMGSetRelaxOrder(precond_, 1);
    HYPRE_BoomerAMGSetMaxLevels(precond_, 9);
    HYPRE_BoomerAMGSetTruncFactor(precond_, 0.25);
    HYPRE_BoomerAMGSetAggNumLevels(precond_, 2);
    HYPRE_BoomerAMGSetAggInterpType(precond_, 4);
    HYPRE_BoomerAMGSetAggPMaxElmts(precond_, 2);
    HYPRE_BoomerAMGSetPMaxElmts(precond_, 2);
    HYPRE_BoomerAMGSetStrongThreshold(precond_, 0.25);


    HYPRE_BoomerAMGSetNumSweeps(precond_, 2);
    HYPRE_BoomerAMGSetTol(precond_, 0.5);
